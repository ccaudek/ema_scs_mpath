// Random slopes for exam_day_pre and exam_day_post are added for each subject. 
// This allows the impact of these variables to vary across participants.
// Random intercepts are included for subjects (alpha_j), days (alpha_d), and measurements 
// within a day (alpha_m), capturing variability at these levels.
// This model will provide a detailed understanding of how the effects of exam days vary 
// across individuals, days, and within-day measurements.
